...
exports.deleteCategory = exports.updateCategory = exports.getCategory = exports.getCategories = exports.createCategorieAdmin = void 0;
const express_async_handler_1 = __importDefault(require("express-async-handler"));
const ErrorHandler_1 = __importDefault(require("../middleware/ErrorHandler"));
const slugify_1 = __importDefault(require("slugify"));
const category_service_1 = require("../services/category.service");
exports.createCategorieAdmin = (0, express_async_handler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const name_slug_ru = name_ru
            ? (0, slugify_1.default)(name_ru, { lower: true })
            : name_slug_uz;
        const name_slug_en = name_en
            ? (0, slugify_1.default)(name_en, { lower: true })
            : name_slug_uz;
