...
exports.deleteCategory = exports.updateCategory = exports.getCategory = exports.getCategoriesByAdmin = exports.getCategories = exports.createCategoryAdmin = void 0;
...
exports.getCategoriesByAdmin = (0, express_async_handler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const categories = yield (0, category_service_1.getCategoriesByAdminService)();
        res.status(200).json({
            success: true,
            message: "Categories fetched successfully",
            categories,
