...
exports.default = RuTshContractHtml;
const numberToWords_1 = require("../../../utils/numberToWords");
function RuTshContractHtml(admin, user, products, isDelivery, data) {
...
<div style="float: right;">
	...
	">
          ...
          ">
				<p style="text-align: center; line-height: 108%; font-size: 8pt">
					<strong><span style="font-family: Cambria;">${(0, numberToWords_1.formatNumber)(Number(data.totalPrice) || 0)}</span></strong>
				</p>
			</td>
			<td style="
            width: 57.85pt;
	...
	<div class="container">
		...
		<div class="column">
			<h2>ЗАКАЗЧИК</h2>
			<p><strong style="font-family:Cambria;">Название:</strong>${user.legal_info.name || "_?_"}</p>
			<p><strong style="font-family:Cambria;">Адрес:</strong> ${user.legal_info.address || "_?_"}</p>
			<p><strong style="font-family:Cambria;">Тел:</strong> ${user.legal_info.phone_number || "_?_"}</p>
			<p><strong style="font-family:Cambria;">ИНН:</strong> ${user.legal_info.inn || "_?_"}</p>
			<p><strong style="font-family:Cambria;">ОКЭД:</strong> ${user.legal_info.oked || "_?_"}</p>
			<p><strong style="font-family:Cambria;">Р/с:</strong> ${user.legal_info.x_r || "_?_"}</p>
			<p><strong style="font-family:Cambria;">Банк:</strong> ${user.legal_info.bank || "_?_"}</p>
