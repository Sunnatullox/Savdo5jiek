...
exports.default = RuFqContractHtml;
const numberToWords_1 = require("../../../utils/numberToWords");
function RuFqContractHtml(admin, user, products, isDelivery, data) {
...
<div style="float: right;">
	...
	<p class="NoSpacing" style="text-indent:35.4pt; text-align:justify; font-size:8pt">
		<span style="font-family:Cambria">именуемый в тексте «ПОСТАВЩИК ПРОДУКЦИИ», начальник исправительной колонии № 5
			...
			style="font-family:Cambria">с другой стороны, заключили настоящее соглашение о следующем:</span>
	</p>
	<p class="NoSpacing" style="text-indent:35.4pt; text-align:center; font-size:8pt">
		<a id="_Hlk172407251"></a><a id="_Hlk172407287"><strong><span style="font-family:Cambria; ">1. Содержание
					договора</span></strong></a>
	</p>
	<p class="NoSpacing" style="text-indent:35.4pt; text-align:justify; font-size:8pt">
		<span style="font-family:Cambria">1.1 «ПОСТАВЩИК ПРОДУК</span><a id="_Hlk172407204"><span
				style="font-family:Cambria">ЦИИ» производится по настоящему договору.</span>
				<strong><span
				style="font-family:Cambria;"> ${data.productsCategoryRu || "_?_"} </span></strong><span
				style="font-family:Cambria">оформление заказа «ПОКУПАТЕЛЯ» на поставку продукции (далее «Товар») с
				производственного предприятия исправительной колонии № 5 (далее – КИН № 5) и направление ее «ПОКУПАТЕЛЮ»
				на основании счет-фактуру, и обязуется обеспечить организацию передачи в его распоряжение, а
				«ПОКУПАТЕЛЬ» обязуется произвести оплату и получить Товар на условиях настоящего договора. Точная марка,
				количество и цена товара указаны в спецификации, указанной в пункте 2.1 настоящего договора.</span></a>
	</p>
	<p class="NoSpacing" style="text-indent:35.4pt; text-align:justify; font-size:8pt">
	...
	<p class="NoSpacing" style="text-indent:35.4pt; text-align:center; font-size:8pt">
		<strong><span style="font-family:Cambria; ">2. ЦЕНА ТОВАРА И ПОРЯДОК ОПЛАТЫ</span></strong>
	</p>
	<p class="NoSpacing" style="text-indent:35.4pt; text-align:justify; font-size:8pt">
		<span style="font-family:Cambria">2.1 Точная марка продукта, количество, служба доставки с доставкой или без
			нее, а также сумма стоимости определяются в следующей спецификации:</span>
	</p>
	<table style="
          width: 100%;
        margin-bottom: 0pt;
	...
	">
          ...
          ">
				<p style="text-align: center; line-height: 108%; font-size: 8pt">
					<span style="font-family: Cambria;">${(0, numberToWords_1.formatNumber)(Number(data.totalPrice) || 0)}</span>
				</p>
			</td>
			<td style="
            width: 57.85pt;
	...
	<p class="NoSpacing" style="text-indent:35.4pt; text-align:justify; font-size:8pt">
		<span style="font-family:Cambria">3.1 Доставка Товара в случае строгого соблюдения «ПОКУПАТЕЛЕМ» условий оплаты,
			...
			Соглашения</span><strong><span style="font-family:Cambria;"> До ${data.contractEndDate || "_?_"}
	...
	<div class="container">
		<div class="column">
			<h2>ПОСТАВЩИК</h2>
			<p><strong style="font-family:Cambria;">Название:</strong> “${admin.AdminInfo.company_name || "_?_"}”</p>
			<p><strong style="font-family:Cambria;">Адрес:</strong> ${admin.AdminInfo.address || "_?_"}</p>
			<p><strong style="font-family:Cambria;">Тел:</strong> ${admin.AdminInfo.tel || "_?_"}</p>
			<p><strong style="font-family:Cambria;">ИНН:</strong> ${admin.AdminInfo.inn || "_?_"}</p>
			<p><strong style="font-family:Cambria;">ОКЭД:</strong> ${admin.AdminInfo.oked || "_?_"}</p>
	...
	<p style="margin-bottom:0pt; text-indent:35.45pt; text-align:justify">
		&#xa0;
	</p>
