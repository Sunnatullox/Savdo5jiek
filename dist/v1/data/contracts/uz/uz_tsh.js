...
exports.default = UzTshContractHtml;
const numberToWords_1 = require("../../../utils/numberToWords");
function UzTshContractHtml(admin, user, products, isDelivery, data) {
...
<body>
	...
	<div style="margin-top: 20px;">
		...
		<div class="container">
			<p class="column" style="font-family:Cambria;; padding-left: 10px;">${data.contractDate || "_?_"} yil</p>
		...
		<p class="NoSpacing" style="text-indent:35.4pt; text-align:justify; font-size:8pt">
			<span style="font-family:Cambria">1.1 Mazkur shartnomaga asosan «MAHSULOT YETKAZIB BERUVCHI» ishlab
				chiqarilgan </span> <strong><span style="font-family:Cambria;">${data.productsCategoryUz || "_?_"}</span></strong><span style="font-family:Cambria"> mahsulotlarini (keyingi oʻrinlarda
        ...
        ">
            ...
            ">
					<p style="text-align: center; line-height: 108%; font-size: 8pt">
						<span style="font-family: Cambria;">${data.deliveryDate || "_?_"} yilgacha</span>
					</p>
				</td>
			</tr>
				`;
            ...
            ">
					<p style="text-align: center; line-height: 108%; font-size: 8pt">
						<span style="font-family: Cambria;">${(0, numberToWords_1.formatNumber)(Number(data.totalPrice))}</span>
					</p>
				</td>
				<td style="
              width: 67.15pt;
		...
		${admin.AdminInfo.x_r}</span></strong><span style="font-family:Cambria">, ochilgan ${admin.AdminInfo.bank} hisob raqamiga </span><strong><span style="font-family:Cambria; ">(MFO ${admin.AdminInfo.mfo}, STIR
		${admin.AdminInfo.inn})</span></strong><span style="font-family:Cambria"> quyidagi usullardan birida yoki ularni
		...
		<p class="NoSpacing" style="text-indent:35.4pt; text-align:justify; font-size:8pt">
			...
			<strong><span
					style="font-family:Cambria;">${data.contractEndDate || "_?_"} yilgacha</span></strong>
					<span
		...
		<div class="container">
			...
			<div class="column">
				<h2>BUYURTMACHI</h2>
				<p><strong style="font-family:Cambria;">Nomi:</strong> ${user.legal_info.name || "_?_"}</p>
				<p><strong style="font-family:Cambria;">Manzili:</strong> ${user.legal_info.address || "_?_"}</p>
				<p><strong style="font-family:Cambria;">Tel:</strong> ${user.legal_info.phone_number || "_?_"}</p>
				<p><strong style="font-family:Cambria;">STIR:</strong> ${user.legal_info.inn || "_?_"}</p>
				<p><strong style="font-family:Cambria;">OKED:</strong> ${user.legal_info.oked || "_?_"}</p>
