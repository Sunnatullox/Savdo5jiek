...
router.get("/get-messages-user", auth_1.isAuthenticatedUser, messagesController.getMessagesUser);
router.get("/get-messages-admin", auth_1.isAuthenticatedAdminstrator, (0, auth_1.isAdministrator)(adminstrator_type_1.Role.ADMIN), messagesController.getMessagesAdmin);
