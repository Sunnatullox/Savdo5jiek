...
router.put("/update-product-status-by-admin/:id", auth_1.isAuthenticatedAdminstrator, (0, auth_1.isAdministrator)(adminstrator_type_1.Role.ADMIN), productController.updateProductStatusByAdmin);
