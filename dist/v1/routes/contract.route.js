...
router.get("/get-contracts-list-by-user", auth_1.isAuthenticatedUser, contractController.getContractsListByUser);
...
router.post("/upload-contract-delivery-doc/:id", auth_1.isAuthenticatedAdminstrator, (0, auth_1.isAdministrator)(adminstrator_type_1.Role.ADMIN), fileUpload_1.docUpload.single("contract_delivery_doc"), contractController.uploadContractDeliveryDoc);
