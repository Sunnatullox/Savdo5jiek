...
router.get("/get-payments-by-user/:id", auth_1.isAuthenticatedUser, payment_controller_1.getPaymentById);
router.get("/get-payments-by-contract/:id", auth_1.isAuthenticatedUser, payment_controller_1.getPaymentsByContractId);
router.get("/get-payments-by-admin/:id", auth_1.isAuthenticatedAdminstrator, (0, auth_1.isAdministrator)(adminstrator_type_1.Role.ADMIN), payment_controller_1.getPaymentByAdmin);
router.get("/get-payments-by-contract-admin/:id", auth_1.isAuthenticatedAdminstrator, (0, auth_1.isAdministrator)(adminstrator_type_1.Role.ADMIN), payment_controller_1.getPaymentsByContractIdAdmin);
