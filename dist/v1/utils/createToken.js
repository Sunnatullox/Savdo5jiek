...
exports.accessTokenExpire = parseInt(process.env.ACCESS_TOKEN_EXPIRE || "72", // 72 hours
10 // base 10
);
exports.refreshTokenExpire = parseInt(process.env.REFRESH_TOKEN_EXPIRE || "3", // 3 days
10);
exports.accessTokenOptions = {
    expires: new Date(Date.now() + exports.accessTokenExpire * 60 * 60 * 1000), // 3 days
    maxAge: exports.accessTokenExpire * 60 * 60 * 1000, // 3 days
    httpOnly: true,
